...
public class ComApp extends Application implements TabSheet.SelectedTabChangeListener, HttpServletRequestListener, Serializable {
    ...
    Window loginWindow;
    Button googleButton, yahooButton, facebookButton, logoutButton;
    User user;
	...
	// ab1.setWidth("1000px");
        ...
        ab1.addComponent(rlPanel, "bottom:50px;right:100p");
	...
	loginWindow.setPositionX(250);
	loginWindow.setPositionY(250);
	...
	googleButton = new Button("google",new Button.ClickListener(){
		public void buttonClick(ClickEvent event){
		    String loginUrl = UserServiceFactory.getUserService().createLoginURL("",null,"gmail.com",null);
		    overallWin.open(new ExternalResource(loginUrl));
		}
	    });
	...
	yahooButton = new Button("yahoo",new Button.ClickListener(){
		public void buttonClick(ClickEvent event){
		    String loginUrl = UserServiceFactory.getUserService().createLoginURL("",null,"yahoo.com",null);
		    overallWin.open(new ExternalResource(loginUrl));
		}
	    });
    ...
    @Override
	public void onRequestEnd(HttpServletRequest req, HttpServletResponse response){
